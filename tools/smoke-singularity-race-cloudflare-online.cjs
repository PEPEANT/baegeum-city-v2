...
[
  ...
  "USER_ROOM_REGISTRY_GRACE_MS", "isUserRoomDirectorySummaryVisible", "Number(summary.players || 0) <= 0",
  "admin_unauthorized",
  ...
  "start_request",
  "host: Boolean(options.host)", "host_disconnected",
  "ENTRY_OPEN_DEFAULT",
  "ROOM_ACTIVE_DEFAULT",
  "race_finished",
...
[
  ...
  "maybeAutoSelectVisibleCloudflareUserRoom", "Number(room.players || 0) > 0",
