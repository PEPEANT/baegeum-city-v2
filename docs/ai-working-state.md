...
Next: After deploy, set or confirm the Worker `ADMIN_TOKEN` secret, then verify live admin with `/admin/state`, empty start, one-user start, reset, and map change.
