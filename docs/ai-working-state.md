...
Next: Browser-check the host control button label/confirm path if needed, then commit/push/deploy both client and Worker so live user rooms can be canceled before final results.
